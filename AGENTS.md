...
- **历史方案B最终结果**：30万元连续复利至 ¥465,672.89，累计 +55.22%，全期最大回撤 -40.36%，夏普 0.32
- **数据准确性处理**：新浪 ETF 交易所 OHLC + 累计分红；处理 122 次现金分红/份额折算，规则核验后保留 37 次真实极端行情
...
|------|----------|----------|------|--------------|
| A 激进 | ¥322,774.48 | +7.59% | 0.10 | -47.04% |
| B 平衡 | ¥465,672.89 | +55.22% | 0.32 | -40.36% |
| C 稳健 | ¥425,391.94 | +41.80% | 0.26 | -40.29% |

方案B逐年：2021 -13.09%、2022 -23.46%、2023 +18.13%、2024 +1.52%、2025 +55.79%、2026 YTD +24.91%。
...
- 2026-08-19: **五年历史回测+页面重构** — 新增新浪OHLC/分红独立数据管线、异常跳变审计、30万元跨年连续复利回测、`/api/historical` 与历史展示板块；补全跨境ETF过滤；页面调整为实时决策优先、历史验证独立展示；方案B最终¥465,672.89（+55.22%，最大回撤-40.36%）
